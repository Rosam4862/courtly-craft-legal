...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Kaplan & William Law Firm" },
      { property: "og:description", content: "Justice. Integrity. Results. Experienced attorneys fighting for your rights." },
